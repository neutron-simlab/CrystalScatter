...
docker run -t --name scattercons-tmp  -v "%cd%:/home/user/project" g76r/qt6-runner:qt-6.8.3-debug sh -c "apt-get update; apt install -y libxkbcommon-dev libgl-dev python3; cp /home/user/project/build/sas_scatter2Cons /bin"
