...
\clearpage
\begin{figure}  % [t] % die History Tabelle am unteren[b] Seitenrand der ersten Seite anzeigen...
...
%18. Jan 2022 & Continue writing and insert screenshots. \\ \hline
%04. Feb 2022 & Finish chapter 2 and start with chapter 3. \\ \hline
...
\begin{minipage}{0.30\textwidth}
	...
	\includegraphics[width=0.98\textwidth]{gui-calculations-1d.png}
\end{minipage}
...
\caption{Combobox {\bf LType}, Lattice type selection} \\
\hline\rowcolor{rowcolor}{\bf Parameter} & \rotatebox{90}{Lamellae} & \rotatebox{90}{Hexagonally packed cylinders (P6/mm)} & \rotatebox{90}{Square packed cylinders (P4/mm)} & \rotatebox{90}{Rectangular centered cylinders (cmm)} & \rotatebox{90}{BCC (lm3m)} & \rotatebox{90}{FCC (Fm3m)} & \rotatebox{90}{HCP (P6/mmc)} & \rotatebox{90}{SC (Pm3m)} & \rotatebox{90}{BCT (l4/mm)} & \rotatebox{90}{Gyroid (Ia3d)} & \rotatebox{90}{OBDD (Pn3m)} & \rotatebox{90}{Plumbers Nightmare (Im3m)} & \rotatebox{90}{None} & \rotatebox{90}{CP-Layers} & \rotatebox{90}{2DHex (GISAXS)} & \rotatebox{90}{2DSquare (GISAXS)} & \rotatebox{90}{1DLam (GISAXS)} & \rotatebox{90}{Fd3m} & \rotatebox{90}{Orthorombic} & \rotatebox{90}{LDQ12} \\
\endfirsthead
\hline\rowcolor{rowcolor}{\bf Parameter} & \rotatebox{90}{Lamellae} & \rotatebox{90}{Hexagonally packed cylinders (P6/mm)} & \rotatebox{90}{Square packed cylinders (P4/mm)} & \rotatebox{90}{Rectangular centered cylinders (cmm)} & \rotatebox{90}{BCC (lm3m)} & \rotatebox{90}{FCC (Fm3m)} & \rotatebox{90}{HCP (P6/mmc)} & \rotatebox{90}{SC (Pm3m)} & \rotatebox{90}{BCT (l4/mm)} & \rotatebox{90}{Gyroid (Ia3d)} & \rotatebox{90}{OBDD (Pn3m)} & \rotatebox{90}{Plumbers Nightmare (Im3m)} & \rotatebox{90}{None} & \rotatebox{90}{CP-Layers} & \rotatebox{90}{2DHex (GISAXS)} & \rotatebox{90}{2DSquare (GISAXS)} & \rotatebox{90}{1DLam (GISAXS)} & \rotatebox{90}{Fd3m} & \rotatebox{90}{Orthorombic} & \rotatebox{90}{LDQ12} \\
\endhead
\hline
uca 				& x & x & x & x & x & x & x & x & x & x & x & x & - & x & x & x & x & x & x & x \\ \hline
ucb 				& - & - & - & x & - & - & - & - & x & - & - & - & - & - & - & - & - & - & x & - \\ \hline
ucc 				& - & - & - & - & - & - & - & - & - & - & - & - & - & - & - & - & - & - & x & - \\ \hline
EditDomainSize 	& x & x & x & x & x & x & x & x & x & x & x & x & - & - & x & x & x & x & x & - \\ \hline
EditAzi 			& x & x & x & x & x & x & x & x & x & x & x & x & - & - & - & - & - & x & x & - \\ \hline
EditDebyeWaller	& x & x & x & x & x & x & x & x & x & x & x & x & - & x & x & x & x & x & x & x \\ \hline
Twinned 			& - & - & - & - & x & x & x & - & - & - & - & - & - & - & - & - & - & - & - & - \\ \hline % CheckBoxTwinned
HKLmax 			& x & x & x & x & x & x & x & x & x & x & x & x & - & x & x & x & x & x & x & x \\ \hline
acpl 			& - & - & - & - & - & - & - & - & - & - & - & - & - & x & - & - & - & - & - & x \\ \hline
bcpl 			& - & - & - & - & - & - & - & - & - & - & - & - & - & x & - & - & - & - & - & x \\ \hline
ComboBoxPeak 	& x & x & x & x & x & x & x & x & x & x & x & x & - & 7 & x & x & x & x & x & 7 \\ \hline
Ceffcyl 			& - & - & - & - & - & - & - & - & - & - & - & - & x & - & - & - & x & - & - & - \\ \hline % EditCeffcyl
...
\begin{longtable}{|L{3.2cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|}
\caption{{\bf ComboBoxParticle}, Particle shape selection} \\
\hline\rowcolor{rowcolor}{\bf Parameter} & \rotatebox{90}{sphere} & \rotatebox{90}{cylinder} & \rotatebox{90}{disk} & \rotatebox{90}{vesicle} & \rotatebox{90}{cube} & \rotatebox{90}{ellipsoid} & \rotatebox{90}{triaxial ellipsoid} & \rotatebox{90}{super ellipsoid, barrel} & \rotatebox{90}{superball} & \rotatebox{90}{excluded volume chain} & \rotatebox{90}{Kratky Porod chain}  \\
\endfirsthead
\hline\rowcolor{rowcolor}{\bf Parameter} & \rotatebox{90}{sphere} & \rotatebox{90}{cylinder} & \rotatebox{90}{disk} & \rotatebox{90}{vesicle} & \rotatebox{90}{cube} & \rotatebox{90}{ellipsoid} & \rotatebox{90}{triaxial ellipsoid} & \rotatebox{90}{super ellipsoid, barrel} & \rotatebox{90}{superball} & \rotatebox{90}{excluded volume chain} & \rotatebox{90}{Kratky Porod chain}  \\
\endhead
\hline
Length			& - & x & x & x & - & x & x & x & x & x & x  \\ \hline
SigmaL			& - & x & x & x & - & x & x & x & x & x & x  \\ \hline
EditRadiusi		& - & - & - & - & - & - & x & x & x & - & -  \\ \hline
Alpha			& - & - & - & - & - & - & - & x & x & - & -  \\ \hline
ComboBoxInterior& x & x & x & - & - & x & x & x & x & x & x  \\ \hline
 \hline
\end{longtable}

\begin{longtable}{|L{3.2cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|}
\caption{{\bf Ordis}, Orientational distribution functions} \\
\hline\rowcolor{rowcolor}{\bf Parameter} & \rotatebox{90}{Gaussian} & \rotatebox{90}{Exponential} & \rotatebox{90}{Onsager} & \rotatebox{90}{Maier-Saupe} & \rotatebox{90}{Cut-off} & \rotatebox{90}{Laguerre} & \rotatebox{90}{z-dir} & \rotatebox{90}{isotropic} & \rotatebox{90}{mirrored Gaussian} & \rotatebox{90}{mirrored Exponential} & \rotatebox{90}{mirrored Onsager} & \rotatebox{90}{mirrored Maier-Saupe} & \rotatebox{90}{mirrored Cut-off} & \rotatebox{90}{fiber pattern}  \\
\endfirsthead
\hline\rowcolor{rowcolor}{\bf Parameter} & \rotatebox{90}{Gaussian} & \rotatebox{90}{Exponential} & \rotatebox{90}{Onsager} & \rotatebox{90}{Maier-Saupe} & \rotatebox{90}{Cut-off} & \rotatebox{90}{Laguerre} & \rotatebox{90}{z-dir} & \rotatebox{90}{isotropic} & \rotatebox{90}{mirrored Gaussian} & \rotatebox{90}{mirrored Exponential} & \rotatebox{90}{mirrored Onsager} & \rotatebox{90}{mirrored Maier-Saupe} & \rotatebox{90}{mirrored Cut-off} & \rotatebox{90}{fiber pattern}   \\
\endhead
\hline
...
\begin{longtable}{|L{3.2cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|C{0.5cm}|}
\caption{{\bf ComboBoxInterior}, Particle nature} \\
\hline\rowcolor{rowcolor}{\bf Parameter} & \rotatebox{90}{homogeneous} & \rotatebox{90}{core + homogeneous sh} & \rotatebox{90}{core + inhomogeneous sh} & \rotatebox{90}{multi-shell} & \rotatebox{90}{myelin}  \\
\endfirsthead
\hline\rowcolor{rowcolor}{\bf Parameter} & \rotatebox{90}{homogeneous} & \rotatebox{90}{core + homogeneous sh} & \rotatebox{90}{core + inhomogeneous sh} & \rotatebox{90}{multi-shell} & \rotatebox{90}{myelin}  \\
\endhead
\hline
EditRadius	& x & x & x & {\small 200} & {\small 200}  \\ \hline
EditRadiusi	& - & x & x & {\small 1} & {\small 1}  \\ \hline
Alpha		& - & - & x & {\small 3.5} & {\small 3.5}  \\ \hline
EditRho		& - & x & x & {\small 3.5} & {\small 3.5}  \\ \hline
 \hline
\end{longtable}
...
\hline\rowcolor{rowcolor}{\bf Parameter} & \rotatebox{90}{Lorentzian} & \rotatebox{90}{Gaussian} & \rotatebox{90}{mod. 1 Lorentzian} & \rotatebox{90}{mod. 2 Lorentzian} & \rotatebox{90}{Pseudo-Voigt} & \rotatebox{90}{Pearson VII} & \rotatebox{90}{Gamma} & \rotatebox{90}{Anisotropic Gaussian}  \\
\endfirsthead
\hline\rowcolor{rowcolor}{\bf Parameter} & \rotatebox{90}{Lorentzian} & \rotatebox{90}{Gaussian} & \rotatebox{90}{mod. 1 Lorentzian} & \rotatebox{90}{mod. 2 Lorentzian} & \rotatebox{90}{Pseudo-Voigt} & \rotatebox{90}{Pearson VII} & \rotatebox{90}{Gamma} & \rotatebox{90}{Anisotropic Gaussian}  \\
\endhead
\hline
